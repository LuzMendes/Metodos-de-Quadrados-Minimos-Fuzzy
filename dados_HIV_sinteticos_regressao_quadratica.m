...
g1 = @(x) 1; %funcoes de base regressao quadratica
g2 = @(x) x; %funcoes de base regressao quadratica
g3 = @(x) x.^2; %funcoes de base regressao quadratica

G = zeros(3,3); %matriz das funcoes de base
F = zeros(3,1); %vetor de resposta dos dados
...
p = @(x) alfa(1)*g1(x)+alfa(2)*g2(x)+alfa(3)*g3(x);
